...
test('it should return selected columns', () => {
...
test('it should nest one to one relation', () => {
    const nesting = nest('user', ['id', 'name']).one('address', ['id', 'country'])
...
test('should nest one to many relation', () => {
    const nesting = nest('user', ['id', 'name']).many('groups', ['id', 'name'])
...
test('should nest mixed relations', () => {
    const nesting = nest('user', ['id', 'name'])
...
test('should deep nest one to one relations', () => {
    const nesting = nest('user', ['id', 'name'])
...
test('should deep nest mixed relations', () => {
